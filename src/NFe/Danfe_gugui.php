...
"\r\n";
        ...
        // Gugui
        // se for 02 cheque ou 15 boleto imprime, else nao


        //Verifica as formas de pagamento da nota fiscal
        $imprimeFatura = false; // gugui
        $formaPag = array();
    ...
    protected function pCabecalhoDANFE($x = 0, $y = 0, $pag = '1', $totPag = '1')
    {
        ...
        if ($this->logoAlign !== 'F') {
            ...
            $gugui_cnpj = substr($this->emit->getElementsByTagName("CNPJ")->item(0)->nodeValue,0,2);
            if($gugui_cnpj === '52') {
                $site = 'www.emar.com.br';
            }
            if($gugui_cnpj === '04') {
                $site = 'www.usimarplasticos.com.br';
            }
